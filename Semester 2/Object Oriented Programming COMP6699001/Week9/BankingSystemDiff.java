...
public class BankingSystemDiff {
    ...
    public static void main(String[] args) {
        ...
        BankDiff bnk1 = new BankDiff(bankName);
        ...
        while(b) {
            ...
            if(choice == 1) {
                ...
                bnk1.add(firstName, lastName);
                bnk1.get(bnk1.size() - 1).setAccount(acc1);

                for(int i = 0; i < bnk1.getNumOfCustomers(); i++) {
		        	System.out.println(bnk1.get(i).getFirstName() + " " + bnk1.getCustomer(i).getLastName() + " registered in " + bnk1.getBankName() + " Bank");
